Feature: Create a post for a salad dressing
    ...
    Scenario: Successfully create a salad dressing post
        ...
        Examples:
            | salad_dressing_id | salad_dressing_name       | username       | description       | ingredients             |
            | 109808907070      | Ranch (the best)          | saladlover123  | Creamy ranch      | buttermilk, mayo, herbs |
            | 901283091851      | Mustard Honey Vinaigrette | greens4life    | Tangy vinaigrette | mustard, honey, vinegar |
            | 083019278311      | Balsamic Glaze            | balsamicfan    | Sweet and tangy   | balsamic vinegar, sugar |
    ...
    Scenario: Add a picture to the salad dressing post
        Given the user is logged in
        When the user navigates to the "Create Post" page
        And the user enters a title, description, and ingredients for the salad dressing
